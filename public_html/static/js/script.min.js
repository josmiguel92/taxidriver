...
options.time=($dateTimePicker.attr("data-time-picker")!="date");options.date=($dateTimePicker.attr("data-time-picker")!="time");options.shortTime=!0;options.minDate=new Date();$dateTimePicker.bootstrapMaterialDatePicker(options)}}
